...
public enum DisplayColor {
     ...
     * Returns an com.swalbert.cosmetics.GUI.ItemFactory with this colour

     *

     * @return An com.swalbert.cosmetics.GUI.ItemFactory that produces an item with the display color
